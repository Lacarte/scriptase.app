...
from scriptase.shared.io_utils import safe_json_write, safe_json_read
...
def _finalize_animator_job(project_id, failed_count):
    ...
    from scriptase.modules.video.animation_routes import _get_job, _save_job, _mark_job_done
