...
def generate_provider_author_guide() -> str:
    ...
    lines: list[str] = [
        ...
        "the settings key — do not rename it after shipping. Pick one of the five "
        "catalog domains and a kind "
        f"({kind_list}).",
        "",
        ...
        "left behind. Use "
        "`python -m scriptase.providers.scaffold --help` for options.",
        "",
        "## 2. Manifest",
        "",
    ...
    lines.extend([
        ...
        "## 7. Tests",
        "",
        "Run the generated contract tests first, then add domain-specific cases. "
        "Reusable suites and offline fakes live in "
