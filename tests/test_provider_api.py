...
class LoopbackPolicyTests(ProviderApiTestCase):
    REQUESTS = [
        ...
        ('get', '/api/providers/tts/inworld', None),
        ('get', '/api/providers/tts/inworld/capabilities', None),
        ('get', '/api/providers/tts/inworld/health', None),
        ('get', '/api/providers/tts/inworld/settings', None),
        ('put', '/api/providers/tts/inworld/settings', {}),
        ('post', '/api/providers/tts/inworld/validate', {}),
        ('post', '/api/providers/tts/inworld/test', {}),
        ('post', '/api/providers/tts/instances/inworld/simulate', {}),
        ('put', '/api/providers/tts/selection', {'provider_id': 'inworld'}),
